...
\begin{titlepage}
    ...
    \vspace{1.5cm}
    % Nhớ thêm file logo vào thư mục và đổi tên tương ứng
...
% ---- CHÈN ẢNH L2 REGULARIZATION ----
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{48.jpg}
