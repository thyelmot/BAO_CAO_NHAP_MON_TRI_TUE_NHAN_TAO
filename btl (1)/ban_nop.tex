...
\end{align}
\textit{Lưu ý: Các công thức (2.12) và (2.13) được trình bày dưới góc độ toán học cho một mẫu dữ liệu dạng vector cột. Khi triển khai thực tế bằng ma trận trên NumPy cho một batch gồm $N$ mẫu dữ liệu, phép toán sẽ được chuyển vị tương ứng thành $Z = AW + b$.}
