...
Để đảm bảo tính thống nhất trong toàn bộ báo cáo, các ký hiệu toán học được sử dụng như Bảng~\ref{tab:symbols}. Theo quy ước phổ biến trong học sâu (Deep Learning), chữ thường biểu diễn vector hoặc scalar, còn chữ hoa biểu diễn ma trận.
...
\end{align}
\textit{Lưu ý: Đối với huấn luyện theo mini-batch, gradient của bias được tính bằng tổng hoặc trung bình của $\delta^{(l)}$ trên toàn bộ batch.}
