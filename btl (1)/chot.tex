...
\titlespacing*{\chapter}{0pt}{-25pt}{15pt} % -25pt để kéo tiêu đề chương lên cao
\titlespacing*{\section}{0pt}{10pt}{5pt}   % Ép khoảng trắng quanh section
\titlespacing*{\subsection}{0pt}{10pt}{5pt} % Ép khoảng trắng quanh subsection
...
Softmax được sử dụng ở lớp đầu ra của bài toán phân loại nhiều lớp, chuyển vector đầu ra thành phân phối xác suất có tổng bằng 1.
\begin{equation}
...
\textbf{Cross-Entropy Loss:} Dùng cho bài toán phân loại.
\begin{equation}
...
\end{equation}
Gradient và cập nhật trọng số sau khi thêm L2:
\begin{align}
...
Kết quả thực nghiệm cho thấy mô hình không thể hội tụ sau quá trình huấn luyện, giá trị Loss không giảm về $0$ và độ chính xác chỉ đạt khoảng 50\%. Các dự đoán vẫn còn sai do Perceptron không tìm được ranh giới phân tách phù hợp.
...
\begin{figure}[H]
    \centering
    \vspace{-0.3cm}
    \includegraphics[width=0.65\textwidth]{42.jpg} \\[0.2cm]
    \includegraphics[width=0.65\textwidth]{43.jpg}
