...
Trong đồ án này, nhóm đã hoàn thành xuất sắc các mục tiêu đề ra ban đầu, bao gồm:
\begin{itemize}
...
Mặc dù đã đạt được nhiều kết quả tích cực, mô hình và đồ án vẫn còn một số hạn chế nhất định:
\begin{itemize}
    ...
    \item \textbf{Thuật toán tối ưu:} Đồ án mới chỉ áp dụng SGD with Momentum. Trong thực tế, các kiến trúc Deep Learning hiện đại thường yêu cầu các thuật toán tối ưu tự thích ứng (Adaptive Learning Rate) như Adam hay RMSprop để hội tụ tốt hơn trên các không gian hao phí phức tạp.
...
Từ những hạn chế trên, nhóm đề xuất các hướng phát triển tiếp theo cho đồ án:
\begin{itemize}
